...
class read_dxlRequest(genpy.Message):
  _md5sum = "85b694b587b06c4e67ace6f2b05239bb"
...
int64 motor_p
"""
  __slots__ = ['action','motor_f','motor_p']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2q().pack(_x.motor_f, _x.motor_p))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.motor_f, _x.motor_p,) = _get_struct_2q().unpack(str[start:end])
      return self
...
class read_dxl(object):
  ...
  _md5sum = '044408118166cb6346b6bae601023969'
