...
(cl:defmethod protocol_version-val ((m <write_dxl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quadruped_robot-srv:protocol_version-val is deprecated.  Use quadruped_robot-srv:protocol_version instead.")
  (protocol_version m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <write_dxl-request>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'protocol_version)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <write_dxl-request>) istream)
  "Deserializes a message object of type '<write_dxl-request>"
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'protocol_version) (cl:if (cl:< unsigned 9223372036854775808) unsigned (cl:- unsigned 18446744073709551616))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<write_dxl-request>)))
  ...
  "81773e62f8a6ec0db8598e75c6beabae")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'write_dxl-request)))
  "Returns md5sum for a message object of type 'write_dxl-request"
  "81773e62f8a6ec0db8598e75c6beabae")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<write_dxl-request>)))
  ...
  (cl:format cl:nil "string action~%int64 protocol_version~%int64 motor_f~%int64 motor_p~%float64 data_f~%float64 data_p~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'write_dxl-request)))
  "Returns full string definition for message of type 'write_dxl-request"
  (cl:format cl:nil "string action~%int64 protocol_version~%int64 motor_f~%int64 motor_p~%float64 data_f~%float64 data_p~%~%~%"))
