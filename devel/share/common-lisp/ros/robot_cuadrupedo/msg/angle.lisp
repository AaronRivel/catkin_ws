...
(cl:defmethod cl:initialize-instance :after ((m <angle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'angle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_cuadrupedo-msg:<angle> is deprecated: use robot_cuadrupedo-msg:angle instead.")))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <angle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_cuadrupedo-msg:angle-val is deprecated.  Use robot_cuadrupedo-msg:angle instead.")
  (angle m))
