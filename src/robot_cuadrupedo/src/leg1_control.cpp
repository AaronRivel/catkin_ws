...
#define DXL_ID_F                          1                   // Dynamixel ID: 1
#define DXL_ID_P                          2                   // Dynamixel ID: 2
...
int main(int argc, char **argv)
{
  ...
  ros::Publisher goal_position_pub = n.advertise<robot_cuadrupedo::motors_states>("Feedback", 1000);
